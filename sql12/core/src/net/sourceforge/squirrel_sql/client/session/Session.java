...
class Session implements ISession
{
   ...
   public List<SQLPanelApiInfo> getAllSQLPanelApiInfos()
   {
      ...
      for(ISessionWidget sessionWindow : sessionWindows)
      {
         ...
         {
            ret.add(SQLPanelApiInfo.ofSQLInternalFrame((SQLInternalFrame) sessionWindow));
         }
...
//		System.out.println("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
   ...
   public IQueryTokenizer getQueryTokenizer()
   {
      if (tokenizer == null || !customTokenizerInstalled)
      {
         ...
         tokenizer = getNewQueryTokenizer();
      }
      return tokenizer;
   }
   ...
   {
      return new QueryTokenizer(_props.getSQLStatementSeparator(),
