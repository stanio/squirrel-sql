...
"%LOCAL_JAVA%" -cp "%SQUIRREL_SQL_HOME%\lib\versioncheck.jar" JavaVersionChecker 17 18 19 20 21 22 23 24
...
start "SQuirreL SQL Client" /B "%LOCAL_JAVA%" -cp %CP% --add-exports=java.desktop/com.sun.java.swing.plaf.windows=ALL-UNNAMED ^
